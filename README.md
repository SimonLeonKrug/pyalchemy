...
Implementations for 2D and 1D can be achieved by dropping $\enspace z $- or $\enspace y,z $-dependencies and forcing $\enspace \mu_z = 0 $ or $\enspace \mu_y = \mu_z = 0 $.

`pyalchemy` does not provide any electron densities, nor functions for numerical integration.
